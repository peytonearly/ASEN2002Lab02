...
%%
% Base Calculations
N = length(PP1(2:end,1)); % Number of elements 
I = 500; 

%average value of the atmospheric temperature and pressure 
Patm = (sum(PP1(2:end,1)) + sum(PP2(2:end,1)) + sum(PP3(2:end,1)) + sum(PP4(2:end,1)) + sum(PP5(2:end,1)) + sum(PP6(2:end,1)) + sum(PP7(2:end,1)) + sum(PP8(2:end,1)) + sum(PP9(2:end,1)) + sum(PP9(2:end,1)) + sum(PP11(2:end,1)) + sum(PP12(2:end,1))) / (N*12);
Tatm = (sum(PP1(2:end,2)) + sum(PP2(2:end,2)) + sum(PP3(2:end,2)) + sum(PP4(2:end,2)) + sum(PP5(2:end,2)) + sum(PP6(2:end,2)) + sum(PP7(2:end,2)) + sum(PP8(2:end,2)) + sum(PP9(2:end,2)) + sum(PP9(2:end,2)) + sum(PP11(2:end,2)) + sum(PP12(2:end,2))) / (N*12);
...
dP = A - B;   %delta P
S_P1D5 = BernoulliEq(dP, R, Tatm,Patm,A1,A2);
...
%%
%Function
BernoulliEq = @(deltaP, R, Tatm, Patm) sqrt(2*deltaP*((R*Tatm)/Patm));
